function [loses, rr_beacons] = extract_loses_bodies_kernel(rr_observer, time_UTC, bodies_list, filename_metakernel, ltscorrection, origin, frame)
% EXTRACT_LOSES_BODIES_KERNEL Computes line-of-sight unit vectors to selected beacons.
%
% Inputs:
...
%
% Outputs:
%   loses          - 3 x N_times x N_beacons array of LoS unit vectors
...
for ix = 1:nb
    ...
    loses(:, :, ix) = loses_beacon ./ vecnorm(loses_beacon);
end
